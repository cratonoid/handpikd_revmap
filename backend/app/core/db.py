...
# Every Document model registered with Beanie. Kept as one module-level
# list (rather than inline in connect_to_mongo) so services/backup.py can
# walk the exact same set of collections for the full-data-export feature
# without maintaining a second, driftable list.
DOCUMENT_MODELS = [
    User,
    UserIdCounter,
    CustomerDetails,
